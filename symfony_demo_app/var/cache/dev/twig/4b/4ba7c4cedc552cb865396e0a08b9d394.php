...
/* user/edit.html.twig */
class __TwigTemplate_ce9c2b4cefbde854f48e0e42410ec266 extends Template
{
...
";
    ...
    public function block_sidebar(array $context, array $blocks = []): iterable
    {
        ...
        yield "\" class=\"btn btn-lg btn-block btn-danger\">
            ";
        // line 20
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("ux:icon", ["name" => "tabler:key"]);
        yield " ";
...
";
    ...
    {
        return array (  171 => 26,  166 => 24,  157 => 20,  153 => 19,  150 => 18,  137 => 17,  124 => 14,  117 => 12,  111 => 9,  107 => 8,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
...
{% block main %}
    ...
    {{ form_start(form) }}
        ...
        <button type=\"submit\" class=\"btn btn-primary\">
            {{ component('ux:icon', { name: 'tabler:save-changes' }) }} {{ 'action.save'|trans }}
        </button>
    {{ form_end(form) }}
{% endblock %}
...
{% block sidebar %}
    <div class=\"section\">
        <a href=\"{{ path('user_change_password') }}\" class=\"btn btn-lg btn-block btn-danger\">
            {{ component('ux:icon', { name: 'tabler:key' }) }} {{ 'action.change_password'|trans }}
        </a>
    </div>
...
{% endblock %}
", "user/edit.html.twig", "C:\\Users\\Sam\\my_project_directory_sam\\symfony_demo_app\\symfony_demo_app\\templates\\user\\edit.html.twig");
    }
}
