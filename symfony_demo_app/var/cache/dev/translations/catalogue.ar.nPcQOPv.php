...
$catalogue = new MessageCatalogue('ar', array (
  'validators+intl-icu' => 
  array (
    'post.slug_unique' => 'تم استخدام هذا العنوان بالفعل في مقال مدونة آخر، ولكن يجب أن يكون فريداً.',
    'post.blank_summary' => 'أعطِ لمقالك ملخصاً!',
    'post.blank_content' => 'مقالك يجب أن يحتوي على محتوى!',
    'post.too_short_content' => 'محتوى مقالك قصير جداً ({limit} أقل عدد أحرف مطلوب)',
    'post.too_many_tags' => 'علامات كثيرة جداً (أضف {limit} علامات أو أقل)',
    'comment.blank' => 'من فضلك لا تترك تعليقك فارغاً!',
    'comment.too_short' => 'التعليق قصير جداً ({limit} أقل عدد أحرف مطلوب)',
    'comment.too_long' => 'التعليق طويل جداً ({limit} أقصى عدد أحرف مسموح به)',
  ...
  array (
    ...
    'http_error.description' => 'حدث خطأ غير معروف (HTTP {status_code, number}) يمنع إكمال طلبك.',
    'http_error.suggestion' => 'حاول تحميل هذه الصفحة مرة أخرى خلال دقائق أو <a href="{url}">ارجع إلى الصفحة الرئيسية</a>.',
    ...
    'http_error_404.suggestion' => 'تحقق من أي خطأ إملائي في العنوان أو <a href="{url}">ارجع إلى الصفحة الرئيسية</a>.',
    'http_error_500.description' => 'حدث خطأ داخلي في الخادم.',
    'http_error_500.suggestion' => 'حاول تحميل هذه الصفحة مرة أخرى خلال دقائق أو <a href="{url}">ارجع إلى الصفحة الرئيسية</a>.',
    'title.homepage' => 'أهلاً بك في تطبيق <strong>سيمفوني التجريبي</strong>',
    'title.source_code' => 'رمز المصدر المستخدم لتقديم هذه الصفحة',
    'title.controller_code' => 'كود المتحكم',
    'title.twig_template_code' => 'كود قالب Twig',
    'title.login' => 'تسجيل دخول آمن',
    'title.post_list' => 'قائمة المقالات',
    'title.edit_post' => 'تعديل مقال #{id, number}',
    'title.add_comment' => 'إضافة تعليق',
    'title.comment_error' => 'حدث خطأ في نشر التعليق',
    'title.edit_user' => 'تعديل المستخدم',
    'title.change_password' => 'تغيير كلمة المرور',
    'action.show' => 'عرض',
    'action.show_post' => 'عرض المقال',
    'action.show_code' => 'عرض الكود',
    'action.edit' => 'تعديل',
    'action.edit_post' => 'تعديل المقال',
    'action.save' => 'حفظ التغييرات',
    'action.delete_post' => 'حذف المقال',
    'delete_post_modal.title' => 'هل أنت متأكد من حذف هذا المقال؟',
    'delete_post_modal.body' => 'لا يمكن التراجع عن هذا الإجراء.',
    'label.delete_post' => 'حذف مقال',
    'label.cancel' => 'إلغاء',
    'action.create_post' => 'إنشاء مقال جديد',
    'label.create_post' => 'إنشاء مقال',
    'label.save_and_create_new' => 'حفظ وإنشاء جديد',
    'action.back_to_list' => 'العودة إلى قائمة المقالات',
    'action.publish_comment' => 'نشر التعليق',
    'action.sign_in' => 'تسجيل الدخول',
    'action.browse_app' => 'تصفح التطبيق',
    'action.browse_admin' => 'تصفح لوحة تحكم الإدارة',
    'action.edit_user' => 'تعديل المستخدم',
    'action.change_password' => 'تغيير كلمة المرور',
    'action.close' => 'إغلاق',
    'label.title' => 'العنوان',
    'label.author' => 'الكاتب',
    'label.author_email' => 'البريد الإلكتروني للكاتب',
    'label.username' => 'اسم المستخدم',
    'label.fullname' => 'الاسم الكامل',
    'label.email' => 'البريد الإلكتروني',
    'label.password' => 'كلمة المرور',
    'label.remember_me' => 'أبقني مسجلاً للدخول',
    'label.current_password' => 'كلمة المرور الحالية',
    'label.new_password' => 'كلمة مرور جديدة',
    'label.new_password_confirm' => 'تأكيد كلمة المرور',
    'label.role' => 'الدور',
    'label.content' => 'المحتوى',
    'label.summary' => 'الملخص',
    'label.published_at' => 'تاريخ النشر',
    'label.tags' => 'العلامات',
    'label.actions' => 'الإجراءات',
    'title.post_new' => 'إنشاء مقال جديد',
    'action.edit_contents' => 'تعديل المحتويات',
    'menu.toggle_nav' => 'تبديل التنقل',
    'menu.choose_language' => 'اختر اللغة',
    'menu.post_list' => 'قائمة المقالات',
    'menu.back_to_blog' => 'العودة إلى المدونة',
    'menu.homepage' => 'الرئيسية',
    'menu.admin' => 'لوحة التحكم',
    'menu.user' => 'الحساب',
    'menu.logout' => 'تسجيل الخروج',
    'menu.rss' => 'مقالات المدونة RSS',
    'menu.search' => 'بحث',
    'post.to_publish_a_comment' => 'لنشر تعليق جديد',
    'post.num_comments' => '{count, plural, one {# تعليق} other {# تعليقات}}',
    'post.commented_on' => 'علق على',
    'post.no_comments' => 'كن أول من يعلق على هذا المقال.',
    'post.no_posts_found' => 'لا توجد مقالات.',
    'post.created_successfully' => 'تم إنشاء المقال بنجاح!',
    'post.updated_successfully' => 'تم تحديث المقال بنجاح!',
    'post.deleted_successfully' => 'تم حذف المقال بنجاح!',
    'post.search_for' => 'البحث عن...',
    'post.search_no_results' => 'لا توجد نتائج للبحث',
    'user.updated_successfully' => 'تم تحديث المستخدم بنجاح!',
    'notification.comment_created' => 'تم إضافة تعليق جديد على مقالك!',
    'notification.comment_created.description' => 'مقالك "{title}" استقبل تعليقاً جديداً. يمكنك قراءة التعليق من خلال متابعة <a href="{link}">هذا الرابط</a>',
    'help.app_description' => 'هذا هو <strong>تطبيق تجريبي</strong> تم بناؤه بواسطة إطار سيمفوني لتوضيح الطريقة الموصى بها لتطوير تطبيقات سيمفوني.',
    'help.show_code' => 'اضغط على هذا الزر لعرض كود <strong>المتحكم</strong> و <strong>القالب</strong> المستخدم لعرض هذه الصفحة.',
    'help.browse_app' => 'استعرض <strong>الجزء العام</strong> من هذا التطبيق التجريبي.',
    'help.browse_admin' => 'استعرض <strong>لوحة تحكم الإدارة</strong> من هذا التطبيق التجريبي.',
    'help.login_users' => 'جرب أي من المستخدمين التاليين',
    'help.role_user' => 'مستخدم عادي',
    'help.role_admin' => 'مدير',
    'help.reload_fixtures' => 'إذا لم تعمل هذه الحسابات، أعد تحميل بيانات التطبيق التجريبية عن طريق تشغيل هذا الأمر من خلال محرر الأوامر:',
    'help.add_user' => 'إذا كنت ترغب في إنشاء مستخدمين جدد، فقم بتشغيل هذا الأمر الآخر:',
    'help.more_information' => 'لمزيد من المعلومات، راجع <a href="https://symfony.com/doc">وثائق سيمفوني</a>.',
    'help.post_summary' => 'لا يمكن أن تحتوي الملخصات على محتويات Markdown أو HTML؛ فقط نص عادي.',
    'help.post_publication' => 'حدد التاريخ في المستقبل لجدولة نشر مقال المدونة.',
    'help.post_content' => 'استخدم Markdown لتنسيق محتويات مقال المدونة. HTML مسموح به أيضاً.',
    ...
    'rss.title' => 'مدونة سيمفوني التجريبية',
    'rss.description' => 'أحدث المقالات المنشورة على مدونة سيمفوني التجريبية',
    'paginator.previous' => 'السابق',
    'paginator.next' => 'التالي',
    'paginator.current' => '(الحالي)',
  ),
));
