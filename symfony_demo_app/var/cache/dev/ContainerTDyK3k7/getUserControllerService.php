...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Rq2gID0'] ?? $container->load('get_ServiceLocator_Rq2gID0Service'))->withContext('App\\Controller\\UserController', $container));
