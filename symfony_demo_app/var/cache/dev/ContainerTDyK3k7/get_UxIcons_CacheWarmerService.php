...
class get_UxIcons_CacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\Icons\IconCacheWarmer(($container->privates['.ux_icons.cache_icon_registry'] ?? $container->load('get_UxIcons_CacheIconRegistryService')), $a);

        if (isset($container->privates['.ux_icons.cache_warmer'])) {
            return $container->privates['.ux_icons.cache_warmer'];
        }

        return $container->privates['.ux_icons.cache_warmer'] = $instance;
    }
}
